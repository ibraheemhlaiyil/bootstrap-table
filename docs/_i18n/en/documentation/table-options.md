...
<table class="table"
    ...
    <tr>
        ...
        <td>Enable/disable detail view per row when <code>detailView</code> is set to <code>true</code>. Return true and the row will be enabled for expansion. Return false and expansion is disabled.</td>
    </tr>
    <tr>
        <td>searchAlign</td>
